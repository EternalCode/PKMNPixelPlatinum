...
extern const u8 gText_Rowan_HelloThere[];
extern const u8 gText_Birch_Welcome[];
extern const u8 gText_Rowan_ControlInfo[];
extern const u8 gText_Rowan_AdventureInfo[];
extern const u8 gText_ThisIsAPokemon[];
extern const u8 gText_Birch_MainSpeech[];
extern const u8 gText_Birch_AndYouAre[];
extern const u8 gText_Birch_BoyOrGirl[];
extern const u8 gText_Birch_YoureAGirl[];
extern const u8 gText_Birch_YoureABoy[];
extern const u8 gText_Birch_WhatsYourName[];
extern const u8 gText_Birch_SoItsPlayer[];
extern const u8 gText_Birch_YourePlayer[];
extern const u8 gText_Rowan_NameRival[];
extern const u8 gText_Rowan_NameRival2[];
...
extern const u8 gText_RowanControlInfo[];
extern const u8 gText_RowanAdventureInfo[];
extern const u8 gText_RowanNoInfoNeeded[];
extern const u8 gText_RowanNewName[];
...
extern const u8 gText_DefaultRivalNameBarry[];
extern const u8 gText_DefaultRivalNameNolan[];
extern const u8 gText_DefaultRivalNameRoy[];
extern const u8 gText_DefaultRivalNameGavin[];
extern const u8 gText_DefaultRivalNameDiamond[];
extern const u8 gText_DefaultRivalNamePearl[];
