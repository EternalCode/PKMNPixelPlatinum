...
static const u8 sSpeciesToBackAnimSet[NUM_SPECIES] =
{
    ...
    [SPECIES_VENUSAUR]   = BACK_ANIM_V_SQUISH_AND_BOUNCE,
    ...
    [SPECIES_PIDGEY]     = BACK_ANIM_V_SHAKE,
    ...
    [SPECIES_GOLEM]      = BACK_ANIM_V_SQUISH_AND_BOUNCE,
    ...
    [SPECIES_RHYDON]     = BACK_ANIM_V_SQUISH_AND_BOUNCE,
    ...
    [SPECIES_MAGIKARP]   = BACK_ANIM_V_SHAKE,
    ...
    [SPECIES_FERALIGATR] = BACK_ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_SENTRET]    = BACK_ANIM_V_SHAKE,
    ...
    [SPECIES_PICHU]      = BACK_ANIM_V_SHAKE,
    [SPECIES_CLEFFA]     = BACK_ANIM_V_SHAKE,
    [SPECIES_IGGLYBUFF]  = BACK_ANIM_V_SHAKE,
    [SPECIES_TOGEPI]     = BACK_ANIM_V_SHAKE,
    [SPECIES_TOGETIC]    = BACK_ANIM_CONVEX_DOUBLE_ARC,
    [SPECIES_NATU]       = BACK_ANIM_V_SHAKE,
    ...
    [SPECIES_SUNKERN]    = BACK_ANIM_V_SHAKE,
    ...
    [SPECIES_TORCHIC]    = BACK_ANIM_V_SHAKE,
    ...
    [SPECIES_TAILLOW]    = BACK_ANIM_V_SHAKE,
    ...
    [SPECIES_AZURILL]    = BACK_ANIM_V_SHAKE,
    [SPECIES_SPOINK]     = BACK_ANIM_CONCAVE_ARC_LARGE,
    [SPECIES_GRUMPIG]    = BACK_ANIM_SHRINK_GROW_VIBRATE,
    [SPECIES_PLUSLE]     = BACK_ANIM_V_SHAKE,
    [SPECIES_MINUN]      = BACK_ANIM_V_SHAKE,
    ...
    [SPECIES_AGGRON]     = BACK_ANIM_V_SQUISH_AND_BOUNCE,
    ...
    [SPECIES_METAGROSS]  = BACK_ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_REGIROCK]   = BACK_ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_REGICE]     = BACK_ANIM_V_SHAKE,
    [SPECIES_REGISTEEL]  = BACK_ANIM_V_SQUISH_AND_BOUNCE,
    ...
    [SPECIES_DEOXYS]     = BACK_ANIM_CONVEX_DOUBLE_ARC,
    [SPECIES_DEOXYS_ATTACK] = BACK_ANIM_CONVEX_DOUBLE_ARC,
    [SPECIES_DEOXYS_DEFENSE] = BACK_ANIM_CONVEX_DOUBLE_ARC,
    [SPECIES_DEOXYS_SPEED] = BACK_ANIM_CONVEX_DOUBLE_ARC,
    [SPECIES_CHIMECHO]   = BACK_ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_TURTWIG]    = BACK_ANIM_DIP_RIGHT_SIDE,
    [SPECIES_GROTLE]     = BACK_ANIM_H_SLIDE,
    [SPECIES_TORTERRA]   = BACK_ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_CHIMCHAR]   = BACK_ANIM_CONCAVE_ARC_SMALL,
    [SPECIES_MONFERNO]   = BACK_ANIM_CONCAVE_ARC_LARGE,
    [SPECIES_INFERNAPE]  = BACK_ANIM_SHAKE_GLOW_RED,
    [SPECIES_PIPLUP]     = BACK_ANIM_V_SHAKE,
    [SPECIES_PRINPLUP]   = BACK_ANIM_H_SLIDE,
    [SPECIES_EMPOLEON]   = BACK_ANIM_GROW,
    [SPECIES_STARLY]     = BACK_ANIM_V_SHAKE,
    [SPECIES_STARAVIA]   = BACK_ANIM_V_SHAKE,
    [SPECIES_STARAPTOR]  = BACK_ANIM_TRIANGLE_DOWN,
    [SPECIES_BIDOOF]     = BACK_ANIM_TRIANGLE_DOWN,
    [SPECIES_BIBAREL]    = BACK_ANIM_V_SHAKE,
    [SPECIES_KRICKETOT]  = BACK_ANIM_V_SHAKE_H_SLIDE,
    [SPECIES_KRICKETUNE] = BACK_ANIM_TRIANGLE_DOWN,
    [SPECIES_SHINX]      = BACK_ANIM_V_SHAKE,
    [SPECIES_LUXIO]      = BACK_ANIM_JOLT_RIGHT,
    [SPECIES_LUXRAY]     = BACK_ANIM_SHAKE_FLASH_YELLOW,
    [SPECIES_BUDEW]      = BACK_ANIM_V_SHAKE,
    [SPECIES_ROSERADE]   = BACK_ANIM_SHAKE_GLOW_GREEN,
    [SPECIES_CRANIDOS]   = BACK_ANIM_JOLT_RIGHT,
    [SPECIES_RAMPARDOS]  = BACK_ANIM_V_SHAKE,
    [SPECIES_SHIELDON]   = BACK_ANIM_DIP_RIGHT_SIDE,
    [SPECIES_BASTIODON]  = BACK_ANIM_H_SHAKE,
    [SPECIES_BURMY]      = BACK_ANIM_V_SHAKE,
    [SPECIES_BURMY_SANDY_CLOAK] = BACK_ANIM_V_SHAKE,
    [SPECIES_BURMY_TRASH_CLOAK] = BACK_ANIM_V_SHAKE,
    [SPECIES_WORMADAM]   = BACK_ANIM_CONVEX_DOUBLE_ARC,
    [SPECIES_WORMADAM_SANDY_CLOAK] = BACK_ANIM_CONVEX_DOUBLE_ARC,
    [SPECIES_WORMADAM_TRASH_CLOAK] = BACK_ANIM_CONVEX_DOUBLE_ARC,
    [SPECIES_MOTHIM]     = BACK_ANIM_CONVEX_DOUBLE_ARC,
    [SPECIES_COMBEE]     = BACK_ANIM_CONVEX_DOUBLE_ARC,
    [SPECIES_VESPIQUEN]  = BACK_ANIM_CONVEX_DOUBLE_ARC,
    [SPECIES_PACHIRISU]  = BACK_ANIM_V_SHAKE_H_SLIDE,
    [SPECIES_BUIZEL]     = BACK_ANIM_CONCAVE_ARC_SMALL,
    [SPECIES_FLOATZEL]   = BACK_ANIM_CONCAVE_ARC_LARGE,
    [SPECIES_CHERUBI]    = BACK_ANIM_CONVEX_DOUBLE_ARC,
    [SPECIES_CHERRIM]    = BACK_ANIM_CONVEX_DOUBLE_ARC,
    [SPECIES_CHERRIM_SUNSHINE] = BACK_ANIM_CONVEX_DOUBLE_ARC,
    [SPECIES_SHELLOS]    = BACK_ANIM_V_STRETCH,
    [SPECIES_SHELLOS_EAST_SEA] = BACK_ANIM_V_STRETCH,
    [SPECIES_GASTRODON]  = BACK_ANIM_GROW,
    [SPECIES_GASTRODON_EAST_SEA] = BACK_ANIM_GROW,
    [SPECIES_AMBIPOM]    = BACK_ANIM_CONCAVE_ARC_LARGE,
    [SPECIES_DRIFLOON]   = BACK_ANIM_GROW,
    [SPECIES_DRIFBLIM]   = BACK_ANIM_GROW,
    [SPECIES_BUNEARY]    = BACK_ANIM_V_SHAKE,
    [SPECIES_LOPUNNY]    = BACK_ANIM_CONCAVE_ARC_LARGE,
    [SPECIES_MISMAGIUS]  = BACK_ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_HONCHKROW]  = BACK_ANIM_SHRINK_GROW_VIBRATE,
    [SPECIES_GLAMEOW]    = BACK_ANIM_V_SHAKE,
    [SPECIES_PURUGLY]    = BACK_ANIM_V_SHAKE_LOW,
    [SPECIES_CHINGLING]  = BACK_ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_STUNKY]     = BACK_ANIM_DIP_RIGHT_SIDE,
    [SPECIES_SKUNTANK]   = BACK_ANIM_DIP_RIGHT_SIDE,
    [SPECIES_BRONZOR]    = BACK_ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_BRONZONG]   = BACK_ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_BONSLY]     = BACK_ANIM_V_SHAKE,
    [SPECIES_MIME_JR]    = BACK_ANIM_V_SHAKE,
    [SPECIES_HAPPINY]    = BACK_ANIM_CONCAVE_ARC_SMALL,
    [SPECIES_CHATOT]     = BACK_ANIM_V_SHAKE_H_SLIDE,
    [SPECIES_SPIRITOMB]  = BACK_ANIM_GROW_STUTTER,
    [SPECIES_GIBLE]      = BACK_ANIM_SHRINK_GROW_VIBRATE,
    [SPECIES_GABITE]     = BACK_ANIM_CONCAVE_ARC_SMALL,
    [SPECIES_GARCHOMP]   = BACK_ANIM_JOLT_RIGHT,
    [SPECIES_MUNCHLAX]   = BACK_ANIM_DIP_RIGHT_SIDE,
    [SPECIES_RIOLU]      = BACK_ANIM_TRIANGLE_DOWN,
    [SPECIES_LUCARIO]    = BACK_ANIM_CONCAVE_ARC_LARGE,
    [SPECIES_HIPPOPOTAS] = BACK_ANIM_H_SLIDE,
    [SPECIES_HIPPOWDON]  = BACK_ANIM_H_SLIDE,
    [SPECIES_SKORUPI]    = BACK_ANIM_V_SHAKE_H_SLIDE,
    [SPECIES_DRAPION]    = BACK_ANIM_H_SHAKE,
    [SPECIES_CROAGUNK]   = BACK_ANIM_V_SHAKE,
    [SPECIES_TOXICROAK]  = BACK_ANIM_TRIANGLE_DOWN,
    [SPECIES_CARNIVINE]  = BACK_ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_FINNEON]    = BACK_ANIM_H_SHAKE,
    [SPECIES_LUMINEON]   = BACK_ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_MANTYKE]    = BACK_ANIM_CONVEX_DOUBLE_ARC,
    [SPECIES_SNOVER]     = BACK_ANIM_H_SHAKE,
    [SPECIES_ABOMASNOW]  = BACK_ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_WEAVILE]    = BACK_ANIM_V_SHAKE_H_SLIDE,
    [SPECIES_MAGNEZONE]  = BACK_ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_LICKILICKY] = BACK_ANIM_GROW,
    [SPECIES_RHYPERIOR]  = BACK_ANIM_V_SQUISH_AND_BOUNCE,
    ...
    [SPECIES_TOGEKISS]   = BACK_ANIM_TRIANGLE_DOWN,
    ...
    [SPECIES_GLISCOR]    = BACK_ANIM_CIRCLE_COUNTERCLOCKWISE,
    [SPECIES_MAMOSWINE]  = BACK_ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_PORYGON_Z]  = BACK_ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_GALLADE]    = BACK_ANIM_SHRINK_GROW_VIBRATE,
    [SPECIES_PROBOPASS]  = BACK_ANIM_V_STRETCH,
    [SPECIES_DUSKNOIR]   = BACK_ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_FROSLASS]   = BACK_ANIM_H_VIBRATE,
    [SPECIES_ROTOM]      = BACK_ANIM_CONVEX_DOUBLE_ARC,
    [SPECIES_ROTOM_WASH] = BACK_ANIM_CONVEX_DOUBLE_ARC,
    [SPECIES_ROTOM_HEAT] = BACK_ANIM_CONVEX_DOUBLE_ARC,
    [SPECIES_ROTOM_FROST] = BACK_ANIM_CONVEX_DOUBLE_ARC,
    [SPECIES_ROTOM_FAN]  = BACK_ANIM_CONVEX_DOUBLE_ARC,
    [SPECIES_ROTOM_MOW]  = BACK_ANIM_CONVEX_DOUBLE_ARC,
    [SPECIES_UXIE]       = BACK_ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_MESPRIT]    = BACK_ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_AZELF]      = BACK_ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_DIALGA]     = BACK_ANIM_H_SHAKE,
    [SPECIES_PALKIA]     = BACK_ANIM_H_SHAKE,
    [SPECIES_HEATRAN]    = BACK_ANIM_V_SHAKE_LOW,
    [SPECIES_REGIGIGAS]  = BACK_ANIM_V_SHAKE,
    [SPECIES_GIRATINA]   = BACK_ANIM_H_VIBRATE,
    [SPECIES_GIRATINA_ORIGIN] = BACK_ANIM_H_VIBRATE,
    [SPECIES_CRESSELIA]  = BACK_ANIM_H_VIBRATE,
    [SPECIES_PHIONE]     = BACK_ANIM_SHAKE_GLOW_BLUE,
    [SPECIES_MANAPHY]    = BACK_ANIM_SHAKE_GLOW_BLUE,
    [SPECIES_DARKRAI]    = BACK_ANIM_H_VIBRATE,
    [SPECIES_SHAYMIN]    = BACK_ANIM_V_SHAKE,
    [SPECIES_SHAYMIN_SKY] = BACK_ANIM_V_SHAKE,
    [SPECIES_ARCEUS]     = BACK_ANIM_H_VIBRATE,
    [SPECIES_ARCEUS_BUG] = BACK_ANIM_H_VIBRATE,
    [SPECIES_ARCEUS_DARK] = BACK_ANIM_H_VIBRATE,
    [SPECIES_ARCEUS_DRAGON] = BACK_ANIM_H_VIBRATE,
    [SPECIES_ARCEUS_ELECTRIC] = BACK_ANIM_H_VIBRATE,
    [SPECIES_ARCEUS_FAIRY] = BACK_ANIM_H_VIBRATE,
    [SPECIES_ARCEUS_FIGHTING] = BACK_ANIM_H_VIBRATE,
    [SPECIES_ARCEUS_FIRE] = BACK_ANIM_H_VIBRATE,
    [SPECIES_ARCEUS_FLYING] = BACK_ANIM_H_VIBRATE,
    [SPECIES_ARCEUS_GHOST] = BACK_ANIM_H_VIBRATE,
    [SPECIES_ARCEUS_GRASS] = BACK_ANIM_H_VIBRATE,
    [SPECIES_ARCEUS_GROUND] = BACK_ANIM_H_VIBRATE,
    [SPECIES_ARCEUS_ICE] = BACK_ANIM_H_VIBRATE,
    [SPECIES_ARCEUS_POISON] = BACK_ANIM_H_VIBRATE,
    [SPECIES_ARCEUS_PSYCHIC] = BACK_ANIM_H_VIBRATE,
    [SPECIES_ARCEUS_ROCK] = BACK_ANIM_H_VIBRATE,
    [SPECIES_ARCEUS_STEEL] = BACK_ANIM_H_VIBRATE,
    [SPECIES_ARCEUS_WATER] = BACK_ANIM_H_VIBRATE,
};
...
static const u8 sBackAnimationIds[] =
{
    ...
    [(BACK_ANIM_V_SQUISH_AND_BOUNCE - 1) * 3]     = ANIM_V_SQUISH_AND_BOUNCE,  ANIM_V_SQUISH_AND_BOUNCE, ANIM_V_SQUISH_AND_BOUNCE_SLOW,
};
